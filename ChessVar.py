...
class ChessVar:
    ...
    def __init__(self):
        ...
        self._referenceBoard = [['N/A', 'a8', 'b8', 'c8', 'd8', 'e8', 'f8', 'g8', 'h8'],
                                ['N/A', 'a7', 'b7', 'c7', 'd7', 'e7', 'f7', 'g7', 'h7'],
                                ['N/A', 'a6', 'b6', 'c6', 'd6', 'e6', 'f6', 'g6', 'h6'],
                                ['N/A', 'a5', 'b5', 'c5', 'd5', 'e5', 'f5', 'g5', 'h5'],
                                ['N/A', 'a4', 'b4', 'c4', 'd4', 'e4', 'f4', 'g4', 'h4'],
                                ['N/A', 'a3', 'b3', 'c3', 'd3', 'e3', 'f3', 'g3', 'h3'],
                                ['N/A', 'a2', 'b2', 'c2', 'd2', 'e2', 'f2', 'g2', 'h2'],
                                ['N/A', 'a1', 'b1', 'c1', 'd1', 'e1', 'f1', 'g1', 'h1']]
        self._liveBoard = [[' 8 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 7 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 6 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 5 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 4 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 3 ', '___', '___', '___', '___', '___', '___', '___', '___'],
                           [' 2 ', 'W_R', 'W1B', 'W1N', '___', '___', 'B1N', 'B1B', 'B_R'],
                           [' 1 ', 'W_K', 'W2B', 'W2N', '___', '___', 'B2N', 'B2B', 'B_K'],
                           ['   ', ' a ', ' b ', ' c ', ' d ', ' e ', ' f ', ' g ', ' h ']]
